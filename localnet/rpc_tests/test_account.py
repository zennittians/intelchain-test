...
def test_get_transactions_count(account_test_tx):
    ...
    # Check v1, SENT
    raw_response = base_request("itc_getTransactionsCount",
    ...
    # Check v2, SENT
    raw_response = base_request("itcv2_getTransactionsCount",
                                params=[account_test_tx["to"], "SENT"],
                                endpoint=endpoints[account_test_tx["shardID"]])
    response = check_and_unpack_rpc_response(raw_response, expect_error=False)
    assert_valid_json_structure(reference_response, response)
...
def test_get_transactions_history_v1():
    ...
    # Check short tx
    raw_response = base_request("itc_getTransactionsHistory",
                                params=[{
                                    "address": address,
                                    "pageIndex": 0,
                                    "pageSize": 1000,
...
def test_get_transactions_history_v2():
    ...
    # Check short tx
    raw_response = base_request("itcv2_getTransactionsHistory",
                                params=[{
                                    "address": address,
                                    "pageIndex": 0,
                                    "pageSize": 1000,
...
def test_get_balances_by_block_number_v1(account_test_tx):
    ...
    raw_response = base_request("itc_getBalanceByBlockNumber",
...
def test_get_balances_by_block_number_v2(account_test_tx):
    ...
    raw_response = base_request("itcv2_getBalanceByBlockNumber",
